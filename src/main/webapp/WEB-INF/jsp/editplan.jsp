...
<body>
	...
	<form:form action="/editplanupdate/" class="modal-content" method="POST" modelAttribute="insplanbyId">
...
<table>
	...
	<input type="hidden" id="thisField" name="inputName" value="${insplanbyId.id}">
	
	<tr>
		<td>
			<form:label path="insurancetype">
	...
	<tr>
		<td>
			<form:label path="premiumname">
				<spring:message text="PREMIUM NAME"/>
			</form:label>
		</td>
		<td>
			<form:input path="premiumname" />
		</td>
	</tr>
	<tr>
		<td>
			<form:label path="numberofbranch">
				<spring:message text="NO.OF BRANCH"/>
			</form:label>
		</td>
		<td>
			<form:input path="numberofbranch" />
		</td>
	</tr>
	<tr>
		<td>
			<form:label path="totalinsuranceamount">
				<spring:message text="TOTAL INSURANCE AMOUNT"/>
			</form:label>
		</td>
		<td>
			<form:input path="totalinsuranceamount" />
		</td>
	</tr>
	<tr>
		<td>
			<form:label path="coverlimit">
				<spring:message text="TTOTAL COVERAGE"/>
			</form:label>
		</td>
		<td>
			<form:input path="coverlimit" />
		</td>
	</tr>
	<tr>
		<td colspan="2">
